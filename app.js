...
function nav(path) {
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-K9HECK7WK2"></script>
	<script>
  		window.dataLayer = window.dataLayer || [];
  		function gtag(){dataLayer.push(arguments);}
  		gtag('js', new Date());

  		gtag('config', 'G-K9HECK7WK2');
	</script>
...
function list(path) {
  var content = `<div class="container">${UI.fixed_header ?'<br>': ''}
	<div id="fitgirlAlert">
		<div class="alert alert-info" id="dodi" style="display:none">
		...
		<div class="alert alert-danger" id="fitgirl" style="display:none">
...
// <li class="breadcrumb-item"><a href="${item}">${navnamecr}</a></li>
  ...
  content += `</ol>
    ...
    *  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables    */
    ...
    s.src = 'https://fitgirlmirror.disqus.com/embed.js';
